...
import { getAllDistricts, getAllDivisions, getAllUpazilas, getDistrictsByDivision } from "@/utils/Address"
...
export default function PropertyForm() {
  ...
  const[division , setDivision]=useState(getAllDivisions());
  ...
  return (
    <form  className="w-full">
       ...
       <div className="w-full grid grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
          <LevelSelect onChange={setDistrict} control={control} data={division} name="propertyDivision" placeholder="Division" error={errors.propertyDivison} label="Division" required/>
          <LevelSelect onChange={setUpzila} control={control} data={district} name="propertyDistrict" placeholder="Discrict" error={errors.propertyDistrict} label="District" required/>
