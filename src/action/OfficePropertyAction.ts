...
import { TOfficeSchema } from '@/utils/zod/OfficeShchema';


export const OfficePropertyAction=async(data: TOfficeSchema, propertyCategory: string , images:string[])=>{
